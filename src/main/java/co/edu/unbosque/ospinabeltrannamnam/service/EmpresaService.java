...
public class EmpresaService {
    ...
    public int updateById(Integer id, EmpresaDTO newData) {
        ...
        Empresa e = opt.get();
        if (newData.getNombre() != null) e.setNombre(newData.getNombre());
        if (newData.getEmail() != null) e.setEmail(newData.getEmail());
        if (newData.getTelefono() != null) e.setTelefono(newData.getTelefono());
        if (newData.getEstado() != null) e.setEstado(newData.getEstado());
