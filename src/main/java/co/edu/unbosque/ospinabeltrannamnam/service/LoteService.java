...
public class LoteService {
    ...
    public int create(LoteDTO data) {
        ...
        // actualizar costoUnitario del ingrediente si es posible (precio / cantidad)
        if (ingredienteEntity != null && data.getPrecio() != null && data.getCantidad() != null && data.getCantidad() > 0) {
            try {
                ...
                // log o manejar error de cálculo, pero no abortar la creación del lote
                ex.printStackTrace();
            }
        }
    ...
    public int updateById(Integer id, LoteDTO newData) {
        ...
        // si precio y cantidad están presentes, recalcular y guardar costoUnitario del ingrediente
        try {
