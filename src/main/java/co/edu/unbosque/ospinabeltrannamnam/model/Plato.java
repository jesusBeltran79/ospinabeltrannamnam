...
public class Plato {
    ...
    // NUEVO: referencia por id a la receta que define los ingredientes de este plato
    @Column(name = "receta_id")
    private Integer recetaId;

    public Plato() { }

    public Plato(String nombre, Integer precioVenta, Integer margenGanancia, Integer costo, String imagen, Integer recetaId) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Plato [platoId=" + platoId + ", nombre=" + nombre + ", precioVenta=" + precioVenta
