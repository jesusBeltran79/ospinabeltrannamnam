...
public class OrdenCompra {
	...
	@ManyToMany
	@JoinTable(name = "orden_ingrediente", joinColumns = @JoinColumn(name = "orden_id"), inverseJoinColumns = @JoinColumn(name = "codigo_ingrediente"))
	...
	public String toString() {
		return "OrdenCompra [ordenId=" + ordenId + ", fechaEmision=" + fechaEmision + ", estado=" + estado
				+ ", empresa=" + (empresa != null ? empresa.getNit() : null) + ", administrador="
				+ (administrador != null ? administrador.getAdministradorId() : null) + ", ingredientes=" + ingredientes
				+ "]";
	}
}
