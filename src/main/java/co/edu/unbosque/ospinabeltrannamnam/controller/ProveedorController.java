...
public class ProveedorController {
    ...
    public ResponseEntity<String> crear(@RequestBody ProveedorDTO dto) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No se pudo crear el proveedor.");
    ...
    public ResponseEntity<?> obtener(@PathVariable Integer id) {
        ...
        if (dto == null) return ResponseEntity.badRequest().body("Proveedor no encontrado.");
    ...
    public ResponseEntity<String> eliminar(@PathVariable Integer id) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No existe el proveedor especificado.");
