...
public class IngredienteController {
    ...
    public ResponseEntity<String> crear(@RequestBody IngredienteDTO dto) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No se pudo crear el ingrediente.");
    ...
    public ResponseEntity<?> obtener(@PathVariable Integer id) {
        ...
        if (dto == null) return ResponseEntity.badRequest().body("Ingrediente no encontrado.");
    ...
    public ResponseEntity<String> eliminar(@PathVariable Integer id) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No existe el ingrediente especificado.");
