...
public class DireccionEmpresaController {
    ...
    public ResponseEntity<?> obtener(@PathVariable Integer id) {
        ...
        if (dto == null) return ResponseEntity.badRequest().body("Dirección no encontrada.");
    ...
    public ResponseEntity<String> eliminar(@PathVariable Integer id) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No existe la dirección especificada.");
