...
public class PlatoController {
    ...
    public ResponseEntity<String> crear(@RequestBody PlatoDTO dto) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No se pudo crear el plato.");
    ...
    public ResponseEntity<?> obtener(@PathVariable Integer id) {
        ...
        if (dto == null) return ResponseEntity.badRequest().body("Plato no encontrado.");
    ...
    public ResponseEntity<String> eliminar(@PathVariable Integer id) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No existe el plato especificado.");
