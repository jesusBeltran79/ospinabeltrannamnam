...
public class AdministradorController {
    ...
    public ResponseEntity<String> crear(@RequestBody AdministradorDTO dto) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No se pudo crear el administrador.");
    ...
    public ResponseEntity<?> obtener(@PathVariable Integer id) {
        ...
        if (dto == null) return ResponseEntity.badRequest().body("Administrador no encontrado.");
    ...
    public ResponseEntity<String> eliminar(@PathVariable Integer id) {
        ...
        if (res != 0) return ResponseEntity.badRequest().body("No existe el administrador especificado.");
